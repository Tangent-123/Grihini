...
<script type="text/javascript">
   ...
   <div class="form_box_left">
    ...
    <div class="form_box_right">
          <asp:TextBox ID="Text_Title" runat="server" style="width:230px; float:left; background-color:#FFF; height:25px; margin:6px 0 0 0; border: 1px solid #dbdbdb;"></asp:TextBox>
                    &nbsp;&nbsp;
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ErrorMessage="Enter Title!" ControlToValidate="Text_Title" 
                        ValidationGroup="Valid1" Display="None"></asp:RequiredFieldValidator>

                    <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                        ControlToValidate="Text_Title" Display="None" 
                        ErrorMessage="Only Character Allowed In Title!" ValidationExpression="^[A-Za-z\s]+$" 
