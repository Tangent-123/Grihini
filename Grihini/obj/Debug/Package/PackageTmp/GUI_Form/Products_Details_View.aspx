...
<div class="productdetails">
    ...
    <div class="add2cart">
        ...
        <asp:ImageButton ID="Btn_addtocart22"  runat="server" ImageUrl="../Images/addtocart2.png" 
...
<div class="product-three">
    ...
    <div  id="zoom1">
        ...
        <asp:Image ID="Product_Image" runat="server" style="height:300px; width:350px; border: 3px solid #666;" data-big-image="../Images/imgProd/triumph_big1.jpg"   class="tiksluszoom" />
